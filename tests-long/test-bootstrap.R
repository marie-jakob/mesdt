...
test_that("compute_tests() uses the correct seed for bootstrapping", {
  ...
  expect_equal(boot_1$pb_objects[[1]]$ref, boot_2$pb_objects[[1]]$ref)
  expect_equal(boot_1$pb_objects[[2]]$ref, boot_2$pb_objects[[2]]$ref)
  expect_equal(boot_1$pb_objects[[3]]$ref, boot_2$pb_objects[[3]]$ref)
